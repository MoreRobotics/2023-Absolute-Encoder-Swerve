...
public class SwerveModule {
    ...
    public void logData() {
        driveMotorSpeed.append(Conversions.falconToMPS(mDriveMotor.getSelectedSensorVelocity(), Constants.Swerve.wheelCircumference,  Constants.Swerve.driveGearRatio));
