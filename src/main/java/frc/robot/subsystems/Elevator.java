...
public class Elevator extends SubsystemBase {
    ...
    public Elevator() {
        ...
        this.controller = new ProfiledPIDController(Constants.ELEVATOR_P, Constants.ELEVATOR_I, Constants.ELEVATOR_D, new Constraints(Constants.ELEVATOR_SPEED, Constants.ELEVATOR_ACC));
